...
Fusion.js is an open source web application framework for building high quality universal React/Redux/Node applications. It's meant for both small and large scale web applications.

Fusion.js has a modular architecture based on universal plugins, which allow developers to easily install only the libraries they need. Plugins can also improve the maintainability and testability of applications thanks to Fusion.js dependency injection system.
